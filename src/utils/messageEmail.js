exports.htmlMessageResetCode = (firstName, lastName, resetCode) => {
  return `<!DOCTYPE html>
<html lang="en">
<body>
        ...
        <div class="email-container">
            <div style="max-width: 600px; margin: auto; padding: 0; background: linear-gradient(135deg, #0857A0 0%, #0a6bc2 100%); font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; border-radius: 16px; overflow: hidden; box-shadow: 0 20px 40px rgba(8, 87, 160, 0.3);">
                ...
                <div style="background: rgba(255, 255, 255, 0.1); backdrop-filter: blur(10px); padding: 30px 20px; text-align: center; border-bottom: 1px solid rgba(255, 255, 255, 0.2);">
                    ...
                    <h2 style="color: white; margin: 0; font-size: 24px; font-weight: 600;">🔐 Password Reset Request</h2>
                    <p style="color: rgba(255, 255, 255, 0.9); margin: 10px 0 0 0; font-size: 16px;">Secure your account with a new password</p>
                </div>
                ...
                <div style="background: white; padding: 40px 30px;">
                    <div style="text-align: center; margin-bottom: 30px;">
                        ...
                        <p style="color: #666; font-size: 16px; line-height: 1.6; margin: 0;">
                            We received a request to reset your <strong style="color: #0857A0;">Trendify</strong> account password. Use the verification code below to create a new password and secure your account.
                        </p>
                    </div>
                    ...
                    <div style="background: linear-gradient(135deg, #f8fbff 0%, #e8f4ff 100%); border: 2px dashed #0857A0; border-radius: 16px; padding: 30px; text-align: center; margin: 30px 0; position: relative;">
                        <div style="position: absolute; top: -12px; left: 50%; transform: translateX(-50%); background: white; padding: 0 15px;">
                            <span style="color: #0857A0; font-size: 14px; font-weight: 600;">RESET CODE</span>
                        </div>
                        <p style="color: #0857A0; font-size: 14px; margin: 0 0 15px 0; font-weight: 500;">Enter this code to reset your password:</p>
                        ...
                        <p style="color: #888; font-size: 13px; margin: 15px 0 0 0;">
                            ⏰ This code expires in <strong style="color: #0857A0;">10 minutes</strong>
                        </p>
                    </div>
                    ...
                    <div style="background: #fff8f0; border: 1px solid #ffd43b; border-radius: 8px; padding: 15px; margin: 25px 0;">
                        <p style="color: #856404; font-size: 14px; margin: 0; line-height: 1.5;">
                            🛡️ <strong>Security Note:</strong> If you didn't request this password reset, please ignore this email. Your account remains secure and no changes will be made.
                        </p>
                    </div>
                </div>
                ...
                <div style="background: #f8f9ff; padding: 25px 30px; text-align: center; border-top: 1px solid #e6ecf0;">
                    ...
                    <p style="color: #aaa; font-size: 12px; margin: 15px 0 0 0;">
                        © 2025 Trendify. All rights reserved.<br>
